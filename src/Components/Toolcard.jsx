...
const Toolcard = () => {
    return (
        <>
            <div className="bg-black py-8 md:py-14">
                <div className="bg-[#181725] mx-4 md:mx-72 rounded-3xl flex flex-col md:flex-row">
                    ...
                    <div className="md:border-l-2 my-4 md:my-12 w-full md:w-1/2">
                        <div className="ml-4 md:ml-20 flex flex-col">
                            <div>
                                <h1 className="text-white text-lg md:text-xl leading-6 md:leading-8 font-bold pr-4 md:pr-32">
                                    Axiobridge creative tools you need in{" "}
                                    <span className="text-[#1F70AF]">one platform</span>
                                </h1>
                            </div>

                            <p className="text-white text-xs md:text-sm leading-5 md:leading-6 flex-grow-0 pr-4 md:pr-20 py-2 md:py-6">
                            ...
                            <div className="ml-auto mr-auto md:ml-0 mt-4 md:mt-10">
